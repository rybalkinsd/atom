...
public class SessionsList {
    ...
    private static class MatchedSocket {
        private WebSocketSession session;
        private String user;

        MatchedSocket(@NotNull WebSocketSession session, String user) {
    ...
    private static List<MatchedSocket> sessions = new CopyOnWriteArrayList<>();

    public static void addSession(WebSocketSession session) {
        sessions.add(new MatchedSocket(session, null));
    }
    ...
    public static WebSocketSession finByUsername(@NotNull String name) {
        for (MatchedSocket session : sessions) {
    ...
    public static String finBySession(@NotNull WebSocketSession session) {
        for (MatchedSocket socket : sessions) {
