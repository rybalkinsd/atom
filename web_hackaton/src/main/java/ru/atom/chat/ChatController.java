...
public class ChatController {
    ...
    public ResponseEntity<String> login(@RequestParam("name") String name) {
        ...
        Triplet<String,Date,String> msg = new Triplet<>("admin", new Date(), "[<b style=\" color:"
    ...
    public ResponseEntity<String> chat() {
        ...
        return new ResponseEntity<>(messages.stream()
                .map(triplet -> "<font color=\"grey\">" + dateFormat.format(triplet.getValue1()) + "</font>"
                        + " <b style=\" color:" + usersOnline.get(triplet.getValue0()) + ";\">"
                        + triplet.getValue0() + "</b>: " + triplet.getValue2())
    ...
    public ResponseEntity say(@RequestParam("name") String name, @RequestParam("msg") String msg) {
        ...
        if (!usersOnline.containsKey(name)) {
            ...
            if (countOfMessages.get(name) > 3) {
                messages.add(new Triplet<>("admin", new Date(), " plz dont spam:"
