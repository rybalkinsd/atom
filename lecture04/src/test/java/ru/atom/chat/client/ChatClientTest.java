...
public class ChatClientTest {
    private static String MY_NAME_IN_CHAT = "artema";
    private static String MY_MESSAGE_TO_CHAT = "fff";
    ...
    public void logout() throws IOException {
        ...
        String body = response.body().string();
        System.out.println();
        Assert.assertTrue(response.code() == 200 || body.equals("You are not logged in anyway :("));
    }
