...
public class ChatResource {
    ...
    private static final ConcurrentHashMap<String, User> loginedUsers = new ConcurrentHashMap<>();
    ...
    public Response login(@QueryParam("name") String name, @QueryParam("pass") String pass) {
        ...
        loginedUsers.put(name, new User(name,pass));
        logined.add(name);
