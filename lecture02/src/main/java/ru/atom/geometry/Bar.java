    ...
    public boolean isColliding(Collider other) {
        if (other instanceof Point) {
            ...
            if (other instanceof Bar) {
                ...
                if (this.firstCornerX <= bar.getFirstCornerX()
                        && this.secondCornerY >= bar.getFirstCornerY()
                        && this.secondCornerX >= bar.getFirstCornerX()
                        && this.firstCornerY <= bar.getFirstCornerY()// ѕравый верхний угол
                        || this.firstCornerX <= bar.getFirstCornerX() && this.firstCornerY <= bar.getSecondCornerY()
                        && this.secondCornerX >= bar.getFirstCornerX()
                        && this.secondCornerY >= bar.getSecondCornerY()// ѕравый левый угол
