...
public class Bar implements Collider {
    ...
    public boolean isColliding(Collider other) {
        if (other instanceof Point) {
            ...
            if (point.getX() > this.rightUp.getX()
                    || point.getY() > this.rightUp.getY()
                    || point.getX() < this.leftDown.getX()
                    || point.getY() < this.leftDown.getY()) {
                return false;
            }
        }
        if (other instanceof Bar) {
            ...
            if (this.getRightUp().getX() < bar.getLeftDown().getX()
                    || this.getRightUp().getY() < bar.getLeftDown().getY()
                    || this.getLeftDown().getX() > bar.getRightUp().getX()
                    || this.getLeftDown().getY() > bar.getRightUp().getY()) {
                return false;
            }
        }
        return true;
