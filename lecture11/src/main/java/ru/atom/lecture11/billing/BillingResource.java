...
public class BillingResource {
    ...
    @Path("/addUser")
    public Response addUser(@FormParam("user") String user, @FormParam("money") Integer money) {
    ...
    @Consumes("application/x-www-form-urlencoded")
    @Path("/sendMoney")
    public Response sendMoney(@FormParam("from") String fromUser, @FormParam("to") String toUser, @FormParam("money") Integer money) {
